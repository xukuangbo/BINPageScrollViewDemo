...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/BINDeveloper/BINPageScrollViewDemo.git"
  ...
  # Or just: s.author    = "BinYu"
  # s.authors            = { "BinYu" => "bg1859710@gmail.com" }
  # s.social_media_url   = "http://twitter.com/BinYu"
